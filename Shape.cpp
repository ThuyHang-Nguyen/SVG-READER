...
//    stroke_color.blue = 0;
//    stroke_opacity = 0.3f; // Độ đậm 20% (đen nhạt)
//
//    Pen pen(Color(stroke_opacity * 255, stroke_color.red, stroke_color.green, stroke_color.blue), stroke_width);
...
//    //    float base = sizes[i] * scale;
//
//    //    float offsetX = upward[i] ? base * 0.2f : base * 0.7f;
//
//    //    PointF p1 = curr;
//    //    PointF p2 = PointF(curr.X + base, curr.Y);
//    //    PointF p3 = upward[i]
//    //        ? PointF(curr.X + offsetX, curr.Y - base)
//    //        : PointF(curr.X + offsetX, curr.Y + base);
//
//    //    allPoints.push_back(p1);
//    //    allPoints.push_back(p2);
...
//        PointF p2 = PointF(curr.X + base, curr.Y);
//
//        float dx = (upward[i] ? -0.2f : 1.3f) * base;
//       float dy = (upward[i] ? -0.6f : 0.8f) * base;
//       PointF p3 = PointF(curr.X + dx, curr.Y + dy);
//
//       allPoints.push_back(p1);
//        allPoints.push_back(p2);
//        allPoints.push_back(p3);
...
//
//    const float angle = 10.0f * M_PI / 180.0f;
...
void polyline::draw(Graphics& graphics) {
    // Äáº·t mÃ u Ä‘en nháº¡t
    //stroke_color.red = 0;
    //stroke_color.green = 0;
    //stroke_color.blue = 0;
    //stroke_opacity = 0.2f; // Äá»™ Ä‘áº­m 20% (Ä‘en nháº¡t)
    ...
    SolidBrush fillBrush(Color(72, 73, 79)); // Alpha 255 = khÃ´ng má»
